...
/** Code from https://sites.google.com/site/indy256/algo/simplex_algorithm
    "Simplex algorithm Jul 4, 2014, 7:46 PM by Andrey Naumenko",
    as per the comments at the site.
 */
public class Simplex {
  ...
  public static Rational simplex(Rational[][] A, Rational[] b, Rational[] c, Rational[] x) {
    ...
    if (a[m + 1][n].signum() < 0) {
	//System.out.println("Negative a["+(m+1)+"]["+n+"]=" + a[m + 1][n]);
	return null;
    }
    if (x != null) {
